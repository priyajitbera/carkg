...
public abstract class VariantRequestMapper {
  ...
  @Mappings({@Mapping(target = "car", source = ".", qualifiedBy = MapCar.class)})
  public abstract void map(
      @MappingTarget Variant variant,
      VariantCreate src,
      @Context VariantRequestMappingContext context);
  ...
  public static GenericListItemMapper<VariantCreate, Variant, VariantRequestMappingContext>
      genericListItemMapper(VariantRequestMapper mapper) {
    GenericListItemMapper<VariantCreate, Variant, VariantRequestMappingContext> listItemMapper =
  ...
  public static GenericListItemMapper2<
          VariantCreate, Variant, CarRequestMappingContext, VariantRequestMappingContext>
      genericListItemMapper2(VariantRequestMapper mapper) {
    GenericListItemMapper2<
            VariantCreate, Variant, CarRequestMappingContext, VariantRequestMappingContext>
        listItemMapper =
            new GenericListItemMapper2<>() {
              @Override
              TriConsumer<Variant, VariantCreate, VariantRequestMappingContext> getMapper() {
              ...
              @Override
              VariantRequestMappingContext getContext(
                  CarRequestMappingContext parentContext, Variant target) {
