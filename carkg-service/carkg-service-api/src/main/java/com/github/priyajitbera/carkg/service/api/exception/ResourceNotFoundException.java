...
public class ResourceNotFoundException extends ResponseStatusException {
  ...
  public static Supplier<ResourceNotFoundException> variantByNameCarId(String name, String carId) {
    return () ->
        new ResourceNotFoundException(
            String.format(
                "%s: %s not found for car with: %s", Variant.class.getSimpleName(), name, carId));
  }
  ...
  public static Supplier<ResourceNotFoundException> engineByNameCarId(String name, String carId) {
    return () ->
        new ResourceNotFoundException(
            String.format(
                "%s: %s not found for car with: %s",
                EngineOption.class.getSimpleName(), name, carId));
  }

  public static Supplier<ResourceNotFoundException> transmissionTypeByNameCarId(
      String name, String carId) {
    return () ->
        new ResourceNotFoundException(
            String.format(
                "%s: %s not found for car with: %s",
                TransmissionType.class.getSimpleName(), name, carId));
  }

  public static Supplier<ResourceNotFoundException> colorOptionByNameCarId(
      String name, String carId) {
    return () ->
        new ResourceNotFoundException(
            String.format(
                "%s: %s not found for car with: %s",
                ColorOption.class.getSimpleName(), name, carId));
  }

  //    public static Supplier<ResourceNotFoundException> transmissionTypeByNameCarBrand(String
  // name, String car, String brand) {
  //        return () -> new ResourceNotFoundException(String.format("%s: %s not found for car: %s
  // of brand: %s", Engine.class.getSimpleName(), name, car, brand));
  //    }
}
