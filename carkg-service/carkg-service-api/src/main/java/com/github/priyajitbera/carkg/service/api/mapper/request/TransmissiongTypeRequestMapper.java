...
public abstract class TransmissiongTypeRequestMapper {
    ...
    public abstract void map(@MappingTarget TransmissionType target, TransmissionTypeCreate src, @Context CarRequestMappingContext context);
    ...
    public static GenericListItemMapper<TransmissionTypeCreate, TransmissionType, CarRequestMappingContext> genericListItemMapper(
            TransmissiongTypeRequestMapper mapper
    ) {
        GenericListItemMapper<TransmissionTypeCreate,
                TransmissionType, CarRequestMappingContext> listItemMapper = new GenericListItemMapper<>() {
            @Override
            TriConsumer<TransmissionType, TransmissionTypeCreate, CarRequestMappingContext> getMapper() {
                return mapper::map;
            }
