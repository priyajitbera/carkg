...
public class SparqlProjectionExtractor {
    /**
     * Inspects a Java POJO class and generates a string of SPARQL SELECT projection
     * variables (e.g., "?carName ?brandName") based on the POJO's field names.
     *
    ...
    public String extractProjection(Class<?> pojoClass) {
        ...
        String projectionString = Arrays.stream(fields)
    ...
    /**
     * Optional: Generates a human-readable list of required fields
     * for AI model context.
     * * @param pojoClass The Class object of the target POJO.
     *
