...
public class ProjectionConfiguration {
    ...
    private final ProjectionRegistrar.ProjectionsContainer registeredSparqlProjections = new ProjectionRegistrar.ProjectionsContainer();
    ...
    public void registerSparqlSelectProjection(Class<?> projectionSchemaType, String extractedProjectionColumns) {
