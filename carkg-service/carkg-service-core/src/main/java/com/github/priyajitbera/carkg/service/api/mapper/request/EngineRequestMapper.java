...
public abstract class EngineRequestMapper {
  ...
  public abstract void map(
      @MappingTarget EngineOption target,
      EngineOptionCreate src,
  ...
  protected FuelType mapFuelType(FuelTypeCreate src, @Context CarRequestMappingContext context) {
    Optional<FuelType> newlyCreatedOpt =
        context.createdFuelTypes().stream()
            .filter(createdFuelType -> Objects.equals(createdFuelType.getName(), src.getName()))
            .findFirst();
  ...
  public static GenericListItemMapper<EngineOptionCreate, EngineOption, CarRequestMappingContext>
      genericListItemMapper(EngineRequestMapper mapper) {
    GenericListItemMapper<EngineOptionCreate, EngineOption, CarRequestMappingContext>
        listItemMapper =
