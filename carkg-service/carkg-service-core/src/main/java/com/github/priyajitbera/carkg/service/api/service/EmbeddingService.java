...
public class EmbeddingService {
  ...
  public EmbeddingService(
      @Value("${embedding.strategy}") String embeddingStrategy,
      @Qualifier("OllamaEmbeddingClient") EmbeddingClient ollamaEmbeddingClient,
      @Qualifier("GeminiEmbeddingClient") EmbeddingClient geminiEmbeddingClient) {
