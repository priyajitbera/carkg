...
public class EngineSemanticSerializer extends SemanticSerializer<EngineOption> {
    @Override
    public void serialize(EngineOption value, JsonGenerator gen, SerializerProvider serializers)
            throws IOException {
