...
public class CarKgMcpTools {
  ...
  public List<CarSemanticSearchModel> semanticSearchCars(
      @ToolParam(description = "Query in natural language e.g. Cars from brand Tata")
          String query) {
  ...
  public BrandModel createUpdateBrand(
      @ToolParam(description = "brandCreate") BrandCreate brandCreate) {
  ...
  public List<BrandSemanticSearchModel> semanticSearchBrands(
      @ToolParam(description = "Query in natural language e.g. Brands which originated from India")
          String query) {
